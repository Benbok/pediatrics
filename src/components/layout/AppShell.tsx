...
export const AppShell: React.FC = () => {
  ...
  return (
    <div className="w-screen h-screen bg-slate-50 dark:bg-slate-950 transition-colors duration-500">
      {/* Custom Title Bar */}
      <TitleBar isDarkMode={isDarkMode} />

      {/* Main layout with sidebar and content */}
      <div className="flex pt-12 h-[calc(100vh-3rem)] min-w-0 overflow-hidden">
        {/* Sidebar - Full height */}
        <aside
          className={clsx(
            "fixed inset-y-0 left-0 z-40 top-12 bottom-0 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border-r border-slate-200 dark:border-slate-800 transition-all duration-500 ease-in-out flex flex-col shadow-2xl shadow-slate-200/50 dark:shadow-none",
