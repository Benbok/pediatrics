  ...
  return (
    <div ref={rootRef} className="relative">
      <button
        ...
        className={[
          'w-full px-3 py-2 rounded-lg border border-slate-300 dark:border-slate-700 dark:bg-slate-800 dark:text-white text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 flex items-center justify-between transition-colors hover:border-emerald-400',
          buttonClassName,
        ].join(' ').trim()}
