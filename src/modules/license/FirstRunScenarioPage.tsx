    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-6">
      <div className="w-full max-w-4xl">
        <div className="text-center mb-10">
          <h1 className="text-3xl sm:text-4xl font-bold text-white tracking-tight">Первый запуск PediAssist</h1>
          <p className="text-slate-300 mt-3 text-sm sm:text-base">Выберите сценарий входа, чтобы продолжить настройку</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <button
            onClick={onChooseAdmin}
            className="group text-left rounded-2xl border border-blue-700/60 bg-blue-950/30 hover:bg-blue-900/40 p-6 transition-colors"
          >
            ...
            <h2 className="text-xl font-semibold text-blue-100">Войти как администратор</h2>
          ...
          <button
            ...
            className="group text-left rounded-2xl border border-emerald-700/60 bg-emerald-950/25 hover:bg-emerald-900/30 p-6 transition-colors"
          >
            <div className="flex items-center justify-between mb-4">
            ...
            <h2 className="text-xl font-semibold text-emerald-100">Войти как пользователь</h2>
