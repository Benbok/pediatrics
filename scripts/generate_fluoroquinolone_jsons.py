...
OUT_DIR = r"C:\Users\Arty\Desktop\Django\pediatrics\src\modules\medications\data\fluoroquinolones"

FLUOROQUINOLONE_ATC_PREFIXES = ("J01MA", "J01MB")
...
def main():
    ...
    where_atc = " OR ".join([f"patc.ATCCode LIKE '{prefix}%'" for prefix in FLUOROQUINOLONE_ATC_PREFIXES])
    docs = cur.execute(
        f"""
