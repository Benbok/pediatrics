...
OUT_DIR = r"C:\Users\Arty\Desktop\Django\pediatrics\src\modules\medications\data\glycopeptides"

GLYCOPEPTIDE_ATC_PREFIXES = ("J01XA",)
...
def main():
    ...
    where_atc = " OR ".join([f"patc.ATCCode LIKE '{prefix}%'" for prefix in GLYCOPEPTIDE_ATC_PREFIXES])
    docs = cur.execute(
        f"""
