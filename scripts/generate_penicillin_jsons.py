...
OUT_DIR = r"C:\Users\Arty\Desktop\Django\pediatrics\src\modules\medications\data\penicillins"

PENICILLIN_CLPH_GROUP_IDS = (169, 170, 172, 173, 175, 1421)
...
def main():
    ...
    group_ids = ", ".join(str(v) for v in PENICILLIN_CLPH_GROUP_IDS)
    docs = cur.execute(
        f"""
        ...
        WHERE pcg.ClPhGroupsID IN ({group_ids})
