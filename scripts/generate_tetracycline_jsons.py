...
OUT_DIR = r"C:\Users\Arty\Desktop\Django\pediatrics\src\modules\medications\data\tetracyclines"

TETRACYCLINE_ATC_PREFIXES = ("J01AA",)
...
def main():
    ...
    where_atc = " OR ".join([f"patc.ATCCode LIKE '{prefix}%'" for prefix in TETRACYCLINE_ATC_PREFIXES])
    docs = cur.execute(
        f"""
