...
OUT_DIR = r"C:\Users\Arty\Desktop\Django\pediatrics\src\modules\medications\data\imidazoles"

IMIDAZOLE_ATC_PREFIXES = ("J01XD",)
...
def main():
    ...
    where_atc = " OR ".join([f"patc.ATCCode LIKE '{prefix}%'" for prefix in IMIDAZOLE_ATC_PREFIXES])
    docs = cur.execute(
        f"""
