...
OUT_DIR = r"C:\Users\Arty\Desktop\Django\pediatrics\src\modules\medications\data\carbapenems"

CARBAPENEM_ATC_PREFIXES = ("J01DH",)
...
def main():
    ...
    where_atc = " OR ".join([f"patc.ATCCode LIKE '{prefix}%'" for prefix in CARBAPENEM_ATC_PREFIXES])
    docs = cur.execute(
        f"""
