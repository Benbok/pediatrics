...
OUT_DIR = r"C:\Users\Arty\Desktop\Django\pediatrics\src\modules\medications\data\nitrofurans"

NITROFURAN_ATC_PREFIXES = ("J01XE",)
...
def main():
    ...
    where_atc = " OR ".join([f"patc.ATCCode LIKE '{prefix}%'" for prefix in NITROFURAN_ATC_PREFIXES])
    docs = cur.execute(
        f"""
