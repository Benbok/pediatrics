...
OUT_DIR = r"C:\Users\Arty\Desktop\Django\pediatrics\src\modules\medications\data\monobactams"

MONOBACTAM_ATC_PREFIXES = ("J01DF",)
...
def main():
    ...
    where_atc = " OR ".join([f"patc.ATCCode LIKE '{prefix}%'" for prefix in MONOBACTAM_ATC_PREFIXES])
    docs = cur.execute(
        f"""
