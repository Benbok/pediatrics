...
OUT_DIR = r"C:\Users\Arty\Desktop\Django\pediatrics\src\modules\medications\data\penicillin-combinations"

PENICILLIN_COMBINATION_ATC_PREFIXES = ("J01CR",)
...
def main():
    ...
    where_atc = " OR ".join([f"patc.ATCCode LIKE '{prefix}%'" for prefix in PENICILLIN_COMBINATION_ATC_PREFIXES])
    docs = cur.execute(
        f"""
