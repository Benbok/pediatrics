...
OUT_DIR = r"C:\Users\Arty\Desktop\Django\pediatrics\src\modules\medications\data\ibuprofen"

IBUPROFEN_NAMES = ("ИБУПРОФЕН", "ИБУПРОФЕН-АКРИХИН")
IBUPROFEN_ATC_CODES = ("M01AE01", "M02AA13")
...
def main():
    ...
    name_placeholders = placeholders(IBUPROFEN_NAMES)
    atc_placeholders = placeholders(IBUPROFEN_ATC_CODES)
    ...
    groups = cur.execute(
        ...
        """,
        (*IBUPROFEN_NAMES, *IBUPROFEN_ATC_CODES),
    ).fetchall()
