...
OUT_DIR = r"C:\Users\Arty\Desktop\Django\pediatrics\src\modules\medications\data\interferon-alpha"

# Pure interferon-alpha preparations (exclude combinations with "+")
INTERFERON_ALPHA_NAMES = (
    "ИНТЕРФЕРОН АЛЬФА",
    "ИНТЕРФЕРОН АЛЬФА-2b",
    "ПЭГИНТЕРФЕРОН АЛЬФА-2b",
)
INTERFERON_ALPHA_ATC_CODES = ("L03AB01", "L03AB05", "L03AB10")
...
def main():
    ...
    name_placeholders = placeholders(INTERFERON_ALPHA_NAMES)
    atc_placeholders = placeholders(INTERFERON_ALPHA_ATC_CODES)
    ...
    groups = cur.execute(
        ...
        """,
        (*INTERFERON_ALPHA_NAMES, *INTERFERON_ALPHA_ATC_CODES),
    ).fetchall()
